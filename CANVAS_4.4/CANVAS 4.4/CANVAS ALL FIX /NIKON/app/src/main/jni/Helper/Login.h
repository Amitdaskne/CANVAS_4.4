...
static size_t WriteMemoryCallback(void *contents, size_t size, size_t nmemb, void *userp) {
    ...
    if (curl) {
		std::string api_key = oxorany("https://venomkey.com/connect");
            ...
            try {
                ...
                if (result[/*status*/ StrEnc("(>_LBm", "\x5B\x4A\x3E\x38\x37\x1E", 6).c_str()] == true) {
                    ...
                    if (rng + 30 > time(0)) {
                        ...
                        auth += UUID;
                        auth += "-";
                        std::string licanse = oxorany("Vm8Lk7Uj2JmsjCPVPVjrLa7zgfx3uz9E"); //licence 
                        auth += licanse.c_str(); 
